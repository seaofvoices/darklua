...
* add support for `const` declaration of variables and functions (e.g. `const var = true` or `const function test() end`) ([#346](https://github.com/seaofvoices/darklua/pull/346))
